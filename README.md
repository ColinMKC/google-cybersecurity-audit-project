# Internal Security Audit Project (Fictional Company)
Google Cybersecurity Professional Certificate — Portfolio Project

## Overview
Demonstrates my ability to conduct an internal security audit, including a risk assessment analysis, controls evaluation, and compliance analysis. All company data is fictional and provided by the Google Cybersecurity Certificate.

## Skills Demonstrated
* Internal security auditing
* Risk assessment analysis
* Controls assessment
* Controls categorization (administrative, technical, physical)
* Documentation skills
* Report writing
* Security governance fundamentals

## Project Components
Scope, Goals, and Risk Assement Report
Control Categories
...
## Disclaimer
This project uses fictional companies, fictional data, and fictional scenarios provided by the Google Cybersecurity Professional Certificate. No real company information is used.
